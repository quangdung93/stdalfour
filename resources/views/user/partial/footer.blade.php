<div class="section-map pt-5 pb-5">
        ...
        <div class="info py-4 px-4">
          <div class="inn">
            <div class="d-flex align-items-center mb-3">
              <div class="icon"><img src="{{ asset('img/home/icon-3.svg') }}" alt=""></div>
              <div class="title"><a href="tel:0906947824">0906947824</a></div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="icon"><img src="{{ asset('img/home/icon-4.svg') }}" alt=""></div>
              <div class="title"><span>contact-us</span></div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="icon"><img src="{{ asset('img/home/icon-5.svg') }}" alt=""></div>
              <div class="title"><span>24953 Paseo De Valencia, #6c, Laguna Hills, Ca 92653</span></div>
            </div>
          </div>
        </div>
        <div class="map"><img class="img-fluid" src="{{ asset('img/home/map-1.png') }}" alt="map"></div>
      </div>
    </div>
  </div>
  <footer id="footer">
    <div class="container">
      <div class="row pt-5 pb-5">
        <div class="col-lg-4">
          <div class="logo mb-3"><a href="#"><img src="{{ asset('img/home/logo.svg') }}" alt=""></a></div>
          <form class="form" action="#">
            <p>Love beauty innovation?</p>
            <div class="input">
              <input type="email" requied placeholder="Email">
              <button type="submit"><img src="{{ asset('img/home/icon-8.svg') }}" alt=""></button>
            </div>
          </form>
          <div class="social mt-4">
            <div class="d-flex align-items-center justify-content-between m-0 p-0">
              <div class="item"><a href="#"><img src="{{ asset('img/home/icon-9.svg') }}" alt=""></a></div>
              <div class="item"><a href="#"><img src="{{ asset('img/home/icon-6.svg') }}" alt=""></a></div>
              <div class="item"><a href="#"><img src="{{ asset('img/home/icon-7.svg') }}" alt=""></a></div>
            </div>
          </div>
        </div>
        <div class="col-lg-8">
  ...
  </footer><a id="top" href="#top"><img src="{{ asset('img/home/top.png') }}" alt=""></a>
  <div class="section-search">
    <div class="text-center pt-3 pb-3 img"><img src="{{ asset('img/home/logo-s.png') }}" alt=""></div><span class="close"><img src="{{ asset('img/home/icon-15.svg') }}" alt=""><span>Close</span></span>
    <form class="form" action="#">
      <div class="input">
        <input type="text" placeholder="Tìm kiếm sản phẩm">
        <button type="submit"><img src="{{ asset('img/home/icon-16.svg') }}" alt=""></button>
      </div>
    </form>
  </div>
  @php
  ...
  <div class="section-cart">
    <div class="head d-flex align-items-center justify-content-between">
      <h3 class="m-0 p-0">Giỏ hàng của bạn</h3><span class="close"><img src="{{ asset('img/home/icon-15.svg') }}" alt></span>
    </div>
    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex">
            <div class="img"><img src="{{ '/timthumb.php?src='.$product->IMAGE.'&w=80&h=80&q=72&zc=2' }}" alt=""></div>
